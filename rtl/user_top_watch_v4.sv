...
// Watch Top Level v4
//
// Implements a watch with selectable edit modes, adjustable blanking, and accurate second setting.
// The mode selector enables independent blanking for hours, minutes, or seconds.
//
// Parameters:
...
module user_top_watch_v4 #(
  ...
  // Enables the rate generator used for blink and editing timing.
  logic run_rate_gen;
